...
#endif
static const unsigned int sock_filter_policy_main_instr_cnt = 20;

static void populate_sock_filter_policy_main( ulong out_cnt, struct sock_filter * out, unsigned int pid_namespace) {
  FD_TEST( out_cnt >= 20 );
...
//  check_write:
    ...
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, 2, /* RET_ALLOW */ 9, /* RET_KILL_PROCESS */ 8 ),
//  check_wait4:
    /* load syscall argument 0 in accumulator */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, offsetof(struct seccomp_data, args[0])),
